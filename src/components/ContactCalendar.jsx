                ...
                <div className='col-lg-6'>
                    ...
                    <div className='calendar-container d-flex justify-content-center'>
                        <Calendar 
                            ...
                            onChange={setDate} 
                            value={date} 
                            onClickDay={ date => contactDays.includes(date.toDateString()) ? setContactDays(contactDays.filter(day => day !== date.toDateString())) : setContactDays([...savedDays, date.toDateString()]) } 
